...
<div class="container">
			...
			<div class="col-md-4">
				<form role="form" class="login_user_form" method="post"
												id="signInForm">
					<div class="row">
						<div class="col-md-12">
							<div class="clearfix"></div>
							<div class="successMessageLogin alert alert-success hidden"></div>
							<div class="errorMessageLogin alert alert-danger hidden"></div>
						</div>
					</div>
					<div class="form-group">
						<input type="email" name="loginUserEmail" class="form-control"
														id="loginUserEmail" placeholder="Email Address" />
					</div>
					<div class="form-group">
						<input type="password" name="loginUserPassword"
														class="form-control" id="loginUserPassword"
					...
					<p class="pull-right" style="margin-top: 10px;">
						<a href="#" class="forgetPasswordLink">Forgot Password</a>?
					</p>
					<button type="submit" class="btn btn-warning btn-block signInBtn">Log
						in</button>
				</form>
			</div>
		</div>
